  ...
  return (
    <section className="bg-background pb-12">
      <div className="mx-auto max-w-[1280px] px-6 pb-8 pt-24 md:px-8">
        ...
        <p className="mt-3 text-base text-muted-foreground">Built for creators who can&apos;t wait.</p>
      </div>
        ...
        >
          ...
          >
            <svg width="40" height="44" viewBox="0 0 40 44" fill="none" aria-hidden>
              <defs>
                <linearGradient id="play-grad" x1="0" y1="0" x2="40" y2="44" gradientUnits="userSpaceOnUse">
                  <stop stopColor="#FF0276" />
                  <stop offset="1" stopColor="#FF621A" />
                </linearGradient>
              </defs>
              <path d="M38 19.4 4.5 1.1A3 3 0 0 0 0 3.7v36.6a3 3 0 0 0 4.5 2.6L38 24.6a3 3 0 0 0 0-5.2Z" fill="url(#play-grad)" />
            </svg>
          </button>
        </div>
      </div>
