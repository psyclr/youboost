        ...
        <div className="max-w-[600px]">
          ...
          <div className="mt-7 flex items-stretch gap-2.5">
            ...
            <div
              ...
              style={{
                background:
                  'linear-gradient(5deg, #363636 0%, #FF222E 0%, #FF561A 92%)',
              }}
            >
              <input
                type="text"
            ...
            <button
              ...
              style={{ background: 'var(--grad-cta-vertical, linear-gradient(180deg, #FF0077 1%, #FF2B1B 54%, #FF691A 100%))' }}
            >
              <span
                aria-hidden
                className="pointer-events-none absolute inset-0 rounded-[5px]"
                style={{
                  background: 'linear-gradient(180deg, rgba(255,255,255,0) 0%, rgba(255,255,255,0.29) 100%)',
