          ...
          <div className="space-y-2">
            <div className="flex items-start gap-2">
              ...
              <span>
                ...
                <DocStatusBadge status="COMPLETED" />
              </span>
            </div>
            <div className="flex items-start gap-2">
              <XCircle className="h-4 w-4 mt-0.5 text-muted-foreground" />
              <span>
                Поставщик отменил на своей стороне → ставишь <DocStatusBadge status="FAILED" />
              </span>
            </div>
          </div>
          <Callout type="warning">
        ...
        <SubSection title="Рефанд">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2">
              <CheckCircle className="h-4 w-4 text-green-500" />
              <span>
                Статус заказа → <DocStatusBadge status="REFUNDED" />
              </span>
            </div>
            <div className="flex items-center gap-2">
              <CheckCircle className="h-4 w-4 text-green-500" />
